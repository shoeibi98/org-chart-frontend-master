    ...
    for (var i in this.config.tags) {
      ...
      null != a.subTreeConfig &&
        (this._layoutConfigs[i] = {
          ...
          levelSeparation:
            null != a.subTreeConfig.levelSeparation ? a.subTreeConfig.levelSeparation : this.config.levelSeparation,
        ...
        ;(r.isVisible = t),
          !1 !== OrgChart.events.publish('visibility-change', [r]) &&
            ...
            (r._loaded
              ...
              : (r._setInitialSizeIfNotSet(), r._draw(!1, OrgChart.action.init)))
      }))
}
;(OrgChart._defaultConfig = function (t) {
        ...
        this.manager.read(
          ...
          function (n) {
            if (
              ...
              (!1 !== a.config.lazyLoading || !0 !== t || e === OrgChart.action.exporting)
            ) {
              ...
              for (var d = 0; d < n.visibleNodeIds.length; d++) {
                var g = n.nodes[n.visibleNodeIds[d]],
                  p = a._get(g.id)
                OrgChart.RENDER_LINKS_BEFORE_NODES && (l += a.ui.link(g, a, s, n.bordersByRootIdAndLevel, n.nodes, e)),
                  (l += a.ui.node(g, p, n.animations, a.config, void 0, void 0, void 0, e, s, a))
              }
              for (d = 0; d < n.visibleNodeIds.length; d++) {
                g = n.nodes[n.visibleNodeIds[d]]
                OrgChart.RENDER_LINKS_BEFORE_NODES || (l += a.ui.link(g, a, s, n.bordersByRootIdAndLevel, n.nodes, e)),
              ...
              if (
                ...
                ;(e !== OrgChart.action.centerNode &&
                  ...
                  (c = h),
                  e === OrgChart.action.init && null != h && (c = h),
                  (a.response = n)
                x = a.ui.svg(a.width(), a.height(), c, a.config, l)
                if (a._initialized) {
                  var f = a.getSvg(),
                    u = f.parentNode
                  u.removeChild(f),
                    u.insertAdjacentHTML('afterbegin', x),
                  ...
                  (a.element.innerHTML = a.ui.css() + x + a.ui.menuButton(a.config)),
                ...
                if (m[0].length > 0) {
                  ...
                  OrgChart.animate(m[0], m[1], m[2], a.config.anim.duration, a.config.anim.func, function () {
                    C || (i && i(), OrgChart.events.publish('redraw', [a]), a._showAfterAnimation(), (C = !0))
                  })
                }
                e === OrgChart.action.centerNode
                  ? OrgChart.animate(
                  ...
                  ? 0 == m[0].length && (C || (i && i(), OrgChart.events.publish('redraw', [a]), (C = !0)))
                  : OrgChart.animate(
                      a.getSvg(),
                      { viewbox: h },
                      { viewbox: a.response.viewBox },
                      ...
                      function () {
                        a.xScrollUI.setPosition(),
                          a.yScrollUI.setPosition(),
                          C || (i && i(), OrgChart.events.publish('redraw', [a]), (C = !0))
                      }
                    ),
                ...
                var O = n.boundary,
                  b = O.maxX - O.minX,
                  v = O.maxY - O.minY,
                  x = a.ui.svg(b, v, [O.minX, O.minY, b, v], a.config, l, s)
                i(x)
              }
            }
          },
  ...
  (OrgChart.prototype._setInitialSizeIfNotSet = function () {
    ;(this.element.style.overflow = 'hidden'),
      ...
      0 == this.element.offsetHeight &&
        ((this.element.style.height = '100%'), 0 == this.element.offsetHeight && (this.element.style.height = '700px')),
      0 == this.element.offsetWidth &&
        ((this.element.style.width = '100%'), 0 == this.element.offsetWidth && (this.element.style.width = '700px'))
  }),
    ...
    if (null != i) {
      ...
      if (null != a) {
        ...
        var h = i.w,
          ...
          O = OrgChart.randomId()
        u.setAttribute('id', O)
        var b = { ripple: OrgChart.t(i.templateName, i.min, this.getScale()).ripple, node: i }
        OrgChart.events.publish('ripple', [this, b]),
          C.setAttribute('x', b.ripple.rect ? b.ripple.rect.x : 0),
          C.setAttribute('y', b.ripple.rect ? b.ripple.rect.y : 0),
          C.setAttribute('width', b.ripple.rect ? b.ripple.rect.width : i.w),
          C.setAttribute('height', b.ripple.rect ? b.ripple.rect.height : i.h),
          C.setAttribute('rx', b.ripple.radius),
          C.setAttribute('ry', b.ripple.radius),
          m.setAttribute('clip-path', 'url(#' + O + ')'),
          m.setAttribute('cx', o),
          m.setAttribute('cy', l),
          m.setAttribute('r', 0),
          m.setAttribute('fill', b.ripple.color),
          m.setAttribute('class', 'boc-ripple'),
          u.appendChild(C),
          f.appendChild(u),
          f.appendChild(m),
          a.appendChild(f),
          OrgChart.animate(m, { r: 0, opacity: 1 }, { r: p, opacity: 0 }, 500, OrgChart.anim.outPow, function () {
            a.removeChild(f)
          })
      }
    }
  ...
  (OrgChart.localStorage.setItem = function (t, e) {
    try {
      ...
      t.code == t.QUOTA_EXCEEDED_ERR
        ...
        : (console.error('Local storage error code:' + t.code), console.error(t))
    }
  }),
  (OrgChart.prototype.canUpdateLink = function (t, e) {
    ...
    var r = this.getNode(e),
      i = this.getNode(t)
    return (
      !(r && i && (r.isPartner || (r.hasPartners && i.isAssistant) || (r.hasAssistants && i.isPartner))) &&
      !this.isChild(t, e)
    )
  }),
    ...
    if (e)
      for (var r = this.config.nodes.length - 1; r >= 0; r--)
        (this.config.nodes[r].pid != t && this.config.nodes[r].stpid != t) ||
          ((this.config.nodes[r].pid = e.pid), (this.config.nodes[r].stpid = e.stpid)),
    ...
    if (e)
      for (var a = this.config.nodes.length - 1; a >= 0; a--)
        this.config.nodes[a].pid == t
          ...
          : this.config.nodes[a].stpid == t && (i[this.config.nodes[a].id] = e.stpid)
  ...
  (OrgChart.prototype._get = function (t) {
    ...
    if (
      ...
      !OrgChart.isNEU(t) &&
      'string' == typeof t &&
      (-1 != t.indexOf('balkan_group_dotted_') || -1 != t.indexOf('balkan_dotted_'))
    ) {
    ...
    return (
      ...
      (l = setInterval(function () {
        for (var d = 0; d < t.length; d++)
          for (var g in r[d]) {
            var p = OrgChart._arrayContains(['top', 'left', 'right', 'bottom', 'width', 'height'], g.toLowerCase())
              ? 'px'
              : ''
            switch (g.toLowerCase()) {
              case 'd':
                ...
                break
              case 'r':
                var C = a((h * s - s) / i) * (r[d][g] - e[d][g]) + e[d][g]
                t[d].setAttribute('r', C)
                break
              case 'x1':
                C = a((h * s - s) / i) * (r[d][g] - e[d][g]) + e[d][g]
                t[d].setAttribute('x1', C)
                break
              case 'x2':
                C = a((h * s - s) / i) * (r[d][g] - e[d][g]) + e[d][g]
                t[d].setAttribute('x2', C)
                break
              case 'y1':
                C = a((h * s - s) / i) * (r[d][g] - e[d][g]) + e[d][g]
                t[d].setAttribute('y1', C)
                break
              case 'y2':
                C = a((h * s - s) / i) * (r[d][g] - e[d][g]) + e[d][g]
                t[d].setAttribute('y2', C)
                break
              case 'rotate3d':
                if (r[d][g]) {
                  var m = e[d][g],
                    O = r[d][g],
                    b = [0, 0, 0, 0]
                  for (var v in m) b[v] = a((h * s - s) / i) * (O[v] - m[v]) + m[v]
                  t[d].style.transform = 'rotate3d(' + b.toString() + 'deg)'
                }
                break
              case 'transform':
                if (r[d][g]) {
                  ;(m = e[d][g]), (O = r[d][g]), (b = [0, 0, 0, 0, 0, 0])
                  for (var v in m) b[v] = a((h * s - s) / i) * (O[v] - m[v]) + m[v]
                  t[d].hasAttribute('transform')
                    ? t[d].setAttribute('transform', 'matrix(' + b.toString() + ')')
                    : (t[d].style.transform = 'matrix(' + b.toString() + ')')
                }
                break
              case 'viewbox':
                if (r[d][g]) {
                  ;(m = e[d][g]), (O = r[d][g]), (b = [0, 0, 0, 0])
                  for (var v in m) b[v] = a((h * s - s) / i) * (O[v] - m[v]) + m[v]
                  t[d].setAttribute('viewBox', b.toString())
                }
                break
              case 'margin':
                if (r[d][g]) {
                  ...
                  for (var v in m) b[v] = a((h * s - s) / i) * (O[v] - m[v]) + m[v]
                  var x = ''
                  for (v = 0; v < b.length; v++) x += parseInt(b[v]) + 'px '
  ...
  (OrgChart.expcollOpenTag =
    '<g ' + OrgChart.attr.control_expcoll_id + '="{id}" transform="matrix(1,0,0,1,{x},{y})"  style="cursor:pointer;">'),
  (OrgChart.upOpenTag =
    '<g ' + OrgChart.attr.control_up_id + '="{id}" transform="matrix(1,0,0,1,{x},{y})" style="cursor:pointer;">'),
  ...
  (OrgChart._addPointLeft = function (t, e, r, i, a) {
    ...
    'bottom' == a
      ...
      : 'top' == a &&
        (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2),
      ...
      n[o].addEventListener('click', function (e) {
        e.preventDefault(),
          OrgChart.events.publish('element-btn-click', [
            i,
            { input: this.parentNode.querySelector('input'), nodeId: t, event: e }
          ])
      })
    }
    this.obj.element.querySelector('[data-add-more-fields-btn]').addEventListener('click', function (t) {
      ...
      var e = this,
        r = OrgChart.elements.textbox(
          {},
          { type: 'textbox', label: i.obj.config.editForm.addMoreFieldName, btn: i.obj.config.editForm.addMoreBtn },
          '280px'
        )
  ...
  (OrgChart.editUI.prototype._focusElement = function (t) {
    ...
    OrgChart.isNEU(this.obj.config.editForm.focusBinding)
      ...
      : (e = this.obj.element.querySelector('[data-binding="' + this.obj.config.editForm.focusBinding + '"]')),
  ...
  (OrgChart.editUI.prototype.content = function (t, e, r, i, a) {
    var n,
      ...
      f = this.obj.getNode(t),
      u = this.obj._get(t),
      C = OrgChart.t(f.templateName, f.min, this.obj.getScale()),
      m = u[g],
      O = u[p]
    ...
    OrgChart.isNEU(m) && (m = ''),
      (O = OrgChart.isNEU(O)
        ...
        : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${O}"></img>`)
    var w = !e,
      k = e ? 'display:none;' : '',
      S = e || !s ? 'display:none;' : '',
      I = C.editFormHeaderColor ? `style="background-color:${C.editFormHeaderColor};"` : '',
      A = document.createElement('form')
    if (
      (A.setAttribute('data-boc-edit-form', ''),
      A.classList.add('boc-edit-form'),
      A.classList.add(this.obj.config.mode),
      A.classList.add(f.templateName),
      A.classList.add(OrgChart.ui._defsIds[f.templateName]),
      Array.isArray(f.tags) && f.tags.length)
    )
      for (b = 0; b < f.tags.length; b++) A.classList.add(f.tags[b])
    ...
    return (
        ...
        for (var t = '', r = 0; r < l.length; r++) {
          ...
          if (Array.isArray(i)) {
            ...
            for (var a = 0; a < i.length; a++) {
              var o = i[a],
                s = OrgChart.elements[o.type](u, o, 'unset', e)
              !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id),
                OrgChart.isNEU(s.value) || N.push(`${o.label}: ${s.value}`),
                (t += s.html)
            }
            t += '</div>'
          } else {
            s = OrgChart.elements[i.type](u, i, '280px', e)
            !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id),
              OrgChart.isNEU(s.value) || N.push(`${i.label}: ${s.value}`),
              (t += s.html)
          }
        }
        return t
      ...
      { element: A, focusId: n, title: m, shareText: N.join('\n') }
    )
  }),
  ...
  (OrgChart.circleMenuUI.prototype._show = function (t, e) {
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
      ...
      if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
        ...
        var f = { nodeId: t, menu: e },
          u = OrgChart.events.publish('show', [this, f])
        if (((this._menu = e), !1 === u)) return !1
        for (
          var C = 0,
            m = Object.keys(f.menu).length,
            O = 2 * a.nodeCircleMenuButton.radius + 4,
            b = 2 * Math.PI * O,
            v = b / m - (2 * a.nodeCircleMenuButton.radius + 2);
          v < 0;

        )
          (O += 8), (v = (b = 2 * Math.PI * O) / m - (2 * a.nodeCircleMenuButton.radius + 2))
        for (var x in ((p = document.createElementNS('http://www.w3.org/2000/svg', 'g')).setAttribute(
              ...
              function (t) {
                ...
                t[0].addEventListener('mouseenter', function (t) {
                  OrgChart.events.publish('mouseenter', [
                    r,
                    { from: i, menuItem: f.menu[e], menuItemName: e, event: t }
                  ])
                }),
        ...
        this._linesInterval.push(
          OrgChart.animate(
            g[0],
            { x1: -a.nodeCircleMenuButton.radius / 2, y1: -6, x2: a.nodeCircleMenuButton.radius / 2, y2: -6 },
            { x1: -7, y1: -7, x2: 7, y2: 7 },
            500,
          ...
          this._linesInterval.push(
            OrgChart.animate(
              g[1],
              { x1: -a.nodeCircleMenuButton.radius / 2, y1: 0, x2: a.nodeCircleMenuButton.radius / 2, y2: 0 },
              { x1: 0, y1: 0, x2: 0, y2: 0 },
              500,
              OrgChart.anim.inOutSin
            )
  ...
  (OrgChart.circleMenuUI.prototype.hide = function () {
    for (var t = this._buttonsInterval.length - 1; t >= 0; t--)
      clearInterval(this._buttonsInterval[t]), this._buttonsInterval.splice(t, 1)
    this._buttonsInterval = []
    ...
    if (null != e) {
      var r = e.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id),
        ...
        a = OrgChart.t(i.templateName, i.min, this.obj.getScale()),
        n = this.obj.element
          .querySelector('[' + OrgChart.attr.control_node_circle_menu_id + '="' + r + '"]')
  ...
  (OrgChart.idb._open = function (t) {
    if (OrgChart._browser().msie) t && t(!1)
      ...
      if (!window.indexedDB)
        return console.error("Your browser doesn't support a stable version of IndexedDB."), void (t && t(!1))
  ...
  (OrgChart.toolbarUI.prototype.init = function (t, e) {
    if (e) {
      ;(this.obj = t),
        ...
        e.expandAll &&
          (this.div.innerHTML +=
            '<div ' + OrgChart.attr.tlbr + '="expand">' + OrgChart.toolbarUI.expandAllIcon + '</div>'),
        e.fit &&
        ...
        e.zoom &&
          ...
          (this.div.innerHTML +=
            '<div ' + OrgChart.attr.tlbr + '="minus">' + OrgChart.toolbarUI.zoomOutIcon + '</div>')),
        e.layout &&
          ((this.div.innerHTML +=
            '<div ' + OrgChart.attr.tlbr + '="layout">' + OrgChart.toolbarUI.layoutIcon + '</div>'),
        ...
        e.fullScreen &&
          (this.div.innerHTML +=
            '<div ' + OrgChart.attr.tlbr + '="fullScreen">' + OrgChart.toolbarUI.openFullScreenIcon + '</div>'),
        ...
        if ('svg' == t.ext)
          if (e) e(t, a.innerHTML)
            ...
            if (
              ...
              l.styles && (a.childNodes[0].insertAdjacentHTML('afterbegin', l.styles), (l.content = a.innerHTML)),
              !1 === s)
            )
              return !1
    ...
    if (Array.isArray(e)) for (var a = 0; a < e.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e[a], r, i)
      ...
      if ((i.push(n), r.min))
        for (a = 0; a < e.stChildrenIds.length; a++)
          OrgChart._exportIterateForJSON_XML_CSV(t, t.getNode(e.stChildrenIds[a]), r, i)
      ...
      if (r.expandChildren)
        for (a = 0; a < e.childrenIds.length; a++)
          OrgChart._exportIterateForJSON_XML_CSV(t, t.getNode(e.childrenIds[a]), r, i)
  ...
  (OrgChart.prototype._pagesFit = function (t, e) {
    ...
    return [
      { vb: a, size: { w: n.w + (t.margin[1] + t.margin[3]), h: n.h + (t.margin[0] + t.margin[2]) }, innerSize: n }
    ]
  }),
  ...
  (OrgChart.prototype._pagesA100 = function (t, e, r) {
    ...
    for (var g = c.w * (100 / r), p = c.h * (100 / r), f = o, u = l, C = []; f < s + o; ) {
      for (; u < h + l; ) {
        var m = [f, u, g, p]
        ;(m = m.join()), C.push({ vb: m, innerSize: c, size: d }), (u += p)
      }
      ;(f += g), (u = l)
    }
    return C
  ...
  (OrgChart.events = (function () {
    ...
    return {
      ...
      removeForEventId: function (e) {
        for (var r in t)
          if (Array.isArray(t[r])) for (var i = t[r].length - 1; i >= 0; i--) t[r][i].event_id == e && t[r].splice(i, 1)
      },
  ...
  (OrgChart._importSetColumnNames = function (t, e) {
    if (-1 == t.indexOf('id') || -1 == t.indexOf('pid')) {
      ...
      for (var f = 0; f < t.length; f++) {
        ;(b = document.createElement('option')).setAttribute('value', t[f])
        var u = document.createTextNode(t[f])
        b.appendChild(u), g.appendChild(b)
      }
      var C = document.createElement('LABEL'),
        m = document.createTextNode('Reports to:')
      C.setAttribute('for', 'pid-select'),
        C.appendChild(m),
        (C.style.fontSize = '16px'),
        (C.style.color = 'rgb(122, 122, 122)'),
        (C.style.padding = '5px'),
      ...
      for (f = 0; f < t.length; f++) {
        ...
        b.appendChild(u), O.appendChild(b)
      }
      ...
      return (
        ...
        (document.onmousemove = function (t) {
          ;(t = t || window.event),
            a._dragging &&
              ((a.style.left = a._originalLeft + t.clientX - a._mouseLeft + 'px'),
  ...
  (OrgChart.prototype._globalMouseDownHandler = function (t, e) {
    ...
    if (this.config.nodeMouseClick == OrgChart.action.pan) {
      for (
        var i = e.target;
        i != t && !i.hasAttribute(OrgChart.attr.control_expcoll_id) && !i.hasAttribute(OrgChart.attr.control_up_id);
    ...
    for (var a = e.target; a != t; ) {
      ...
      if (a.hasAttribute(OrgChart.attr.control_node_circle_menu_name))
        return e.stopPropagation(), e.preventDefault(), void this._nodeCircleNodeMenuItemMouseDownHandler(a, e, r)
      a = a.parentNode
    }
  }),
  (OrgChart.prototype._globalClickHandler = function (t, e) {
    ...
    for (var l = e.target; l != t; ) {
      ...
      if (l.hasAttribute(OrgChart.attr.control_node_circle_menu_name))
        return e.stopPropagation(), e.preventDefault(), void this._nodeCircleMenuItemClickHandler(l, e)
      ...
      if (l.hasAttribute(OrgChart.attr.c_link_from))
        return void OrgChart.events.publish('clink-click', [
          this,
          { from: l.getAttribute(OrgChart.attr.c_link_from), to: l.getAttribute(OrgChart.attr.c_link_to), event: e }
        ])
      if (l.hasAttribute(OrgChart.attr.s_link_from))
        return void OrgChart.events.publish('slink-click', [
          this,
          { from: l.getAttribute(OrgChart.attr.s_link_from), to: l.getAttribute(OrgChart.attr.s_link_to), event: e }
        ])
      l = l.parentNode
    }
  }),
  ...
  (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (t, e, r) {
    ...
    if (n.draggable) {
      ...
      f.setAttribute('transform', 'matrix(1,0,0,1,' + (C + O.x) + ',' + (m + O.y) + ')'), (f.style.opacity = 0.7)
      var b = function (t, e) {
          if (null != t) {
          ...
          if (p) {
            ...
            if (s.left || s.right || s.up || s.down) {
              ...
              if (
                ...
                !1 ===
                  OrgChart.events.publish('drag', [o.nodeCircleMenuUI, { from: I, menuItem: n, menuItemName: a }]) &&
                  x(),
                  (t._dragEventFired = !0)
              f.setAttribute('transform', 'matrix(' + u.toString() + ')')
            }
        ...
        x = function (e) {
          if (
            ...
            return (
              ...
              void (
                t._dragEventFired &&
                OrgChart.events.publish('drop', [o.nodeCircleMenuUI, { from: s.id, menuItemName: a, menuItem: n }])
              )
            )
          var i = o.getNode(c)
          OrgChart.events.publish('drop', [o.nodeCircleMenuUI, { from: s.id, to: i.id, menuItem: n, menuItemName: a }]),
            b(c, d),
            g.removeChild(f),
            (o._gragStartedId = null)
        }
  ...
  (OrgChart.prototype._nodeMouseDownHandler = function (t, e, r) {
    if (this.config.enableDragDrop) {
      ...
      var s = this,
        ...
        f = s.getScale(),
        u = t.cloneNode(!0)
      u.setAttribute('data-n-id', 'draging'), h.insertBefore(u, h.firstChild), (u.style.opacity = 0.7)
      var C = function (t, e) {
          if (null != t) {
            e.classList.remove('boc-drag-over')
          ...
          if (c) {
            ...
            if (m.left || m.right || m.up || m.down) {
              ...
              if (
                ...
                (d[5] = p + E),
                !t._dragEventFired &&
                  (Math.abs(r.x - c.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE ||
                    Math.abs(r.y - c.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
              )
                !1 === OrgChart.events.publish('drag', [s, k, e]) && O(), (t._dragEventFired = !0)
              u.setAttribute('transform', 'matrix(' + d.toString() + ')')
            }
          }
        },
        O = function (e) {
          if (
            ...
            h.classList &&
              ...
              h.classList.remove('boc-cursor-nodrop'),
              h.classList.remove('boc-cursor-copy')),
            h.removeEventListener(r.move, m),
            h.removeEventListener(r.up, O),
            r.leave && h.removeEventListener(r.leave, O),
            n.id == o || null == o)
          )
            return (
              t._dragEventFired && OrgChart.events.publish('drop', [s, n.id, void 0, u]),
              h.removeChild(u),
              void (s._gragStartedId = null)
            )
          var i = s.getNode(o)
          if (!1 === OrgChart.events.publish('drop', [s, n.id, i.id, u]))
            return C(o, l), h.removeChild(u), void (s._gragStartedId = null)
          if (s.canUpdateLink(n.id, o)) {
            var a = s.get(n.id)
            ;(a.pid = o), (a.stpid = null), s.updateNode(a, null, !0)
          } else h.removeChild(u), C(o, l)
          s._gragStartedId = null
        }
      h.addEventListener(r.move, m), h.addEventListener(r.up, O), r.leave && h.addEventListener(r.leave, O)
    }
  }),
      ...
      if (!this._moveInterval) {
        ...
        OrgChart.isNEU(r) && (r = OrgChart.anim.inSin),
          ...
          (this._moveInterval = setInterval(function () {
            ...
            t.left
              ? (l++, (c.x = (l * OrgChart.MOVE_STEP) / o), (c.xWithoutScale = l * OrgChart.MOVE_STEP))
              : t.right && (l++, (c.x = (-l * OrgChart.MOVE_STEP) / o), (c.xWithoutScale = -l * OrgChart.MOVE_STEP)),
              t.up
                ? (s++, (c.y = (s * OrgChart.MOVE_STEP) / o), (c.yWithoutScale = s * OrgChart.MOVE_STEP))
                : t.down && (s++, (c.y = (-s * OrgChart.MOVE_STEP) / o), (c.yWithoutScale = -s * OrgChart.MOVE_STEP))
            var d = r((10 * h - 10) / i)
            ;(c.x = c.x * d),
              (c.xWithoutScale = c.xWithoutScale * d),
              (c.y = c.y * d),
              (c.yWithoutScale = c.yWithoutScale * d),
  ...
  (OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    ...
    e.touches &&
      e.touches.length > 1 &&
      ((s.type = 'pinch'), (s.dist = Math.sqrt((o.x - l.x) * (o.x - l.x) + (o.y - l.y) * (o.y - l.y)))),
      'pan' == s.type && (this._hideBeforeAnimation(), this._changeCursorOnPanStart(a, n, e))
    var h = function (t) {
      ...
      c = function () {
        'pan' == s.type && i.config.sticky
          ...
          t.removeEventListener(r.up, c),
          r.leave && t.removeEventListener(r.leave, c),
          r.touchstart && t.removeEventListener(r.touchstart, c)
      }
    this.config.enablePan &&
      (t.addEventListener(r.move, h),
      t.addEventListener(r.up, c),
      r.leave && t.addEventListener(r.leave, c),
      r.touchstart && t.addEventListener(r.touchstart, c))
  }),
    ...
    var c = function () {
        ...
        null == r && t.length > 0
          ...
          : t.length > 0 &&
            ...
            (r.removeAttribute('data-selected'), r.nextSibling.setAttribute('data-selected', 'yes'))
      },
      d = function () {
        var t = e.obj.element.querySelectorAll('[data-search-item-id]'),
          r = e.obj.element.querySelector('[data-selected="yes"]')
        null == r && t.length > 0
          ...
          : t.length > 0 &&
            ...
            (r.removeAttribute('data-selected'), r.previousSibling.setAttribute('data-selected', 'yes'))
      }
  }),
    ...
    if (t) {
      if (t.hasAttribute('data-search-item-id')) {
        ...
        if (this.input.value != OrgChart.SEARCH_HELP_SYMBOL)
          0 != OrgChart.events.publish('searchclick', [this.obj, e]) && this.obj.center(e)
        else (this.input.value = e + ' '), (this.searchTableWrapper.innerHTML = '')
      }
    } else
      (this._searchAfterEnterPress = !0), this.__search(), (this.searchTableWrapper.innerHTML = ''), this.obj.draw()
  }),
  (OrgChart.searchUI.prototype._initSearchFields = function () {
    ...
    if (null == this.obj.config.searchFieldsAbbreviation) {
      ...
      for (t = 0; t < this._searchFields.length; t++) {
        for (
          var r = this._searchFields[t], i = 0, a = r.slice(0, i + 1).toLowerCase();
  ...
  (OrgChart.searchUI.prototype._search = function () {
      ...
      t = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${(function () {
        for (var t = '', i = 0; i < e.lastSearch.length && !(i >= OrgChart.SEARCH_RESULT_LIMIT); i++) {
          ...
          if (r) {
            ...
            'function' == typeof r ? (n = r(e.obj, e.obj.getNode(a.id), o)) : o[r] && (n = o[r])
          }
          var l = '',
            s = ''
          e.obj.config.searchDisplayField == a.__searchField
            ...
            ? ((l = a[e.obj.config.searchDisplayField]), OrgChart.isNEU(l) && (l = ''), (s = a.__searchMarks))
            : (l = a.__searchMarks),
    ...
    for (var i = this.obj.element.querySelectorAll('[data-search-item-id]'), a = 0; a < i.length; a++)
  ...
  (OrgChart.searchUI.prototype.hide = function () {
    this._searchAfterEnterPress && ((this._searchAfterEnterPress = !1), this.obj.draw()),
      ...
      this.input &&
        ...
        document.activeElement == this.xBtn && OrgChart.input.blurHandler(this.input))
  }),
  void 0 === OrgChart && (OrgChart = {}),
  ...
  (OrgChart.manager.prototype.read = function (t, e, r, i, a, n, o, l) {
    ...
    OrgChart.state._get(this.config.state, e, r, function (h) {
      ...
      var c = s.maxX,
        ...
        C = s.nodes
      if (t) {
        var m = OrgChart.manager._getResponse(
          e,
          r,
          s.visibleNodeIds,
          s.config,
        ...
        a != OrgChart.action.exporting &&
          ...
          (s.roots = u),
          (s.nodes = C),
          (s.visibleNodeIds = m.visibleNodeIds)),
          (m.bordersByRootIdAndLevel = f),
          (m.roots = u),
          (m.adjustify = { x: 0, y: 0 }),
          s.state && (m.adjustify = s.state.adjustify),
          o(m)
      } else
        (s.oldNodes = C || null),
          s._read(function (t) {
    ...
    null == o && (o = OrgChart.local),
      o._setPositions(
        ...
        function (e) {
          ...
          for (var l = { minX: null, minY: null, maxX: null, maxY: null }, s = {}, h = 0; h < n.length; h++)
  ...
  (OrgChart.manager._initNode = function (t, e, r, i, a, n, o) {
    ...
    for (var p = 0; p < t.childrenIds.length; p++) {
      var f = e[t.childrenIds[p]]
      if ((OrgChart.manager._setCollpasedProperty(f, g, c, a, h, i, d), !f.collapsed)) {
        if (((f.parent = t), null != f.ppid)) {
          var u = e[f.ppid]
          u && (f.parentPartner = u)
        }
    ...
    if (
      (h != OrgChart.action.minimize || t.min
        ? h == OrgChart.action.maximize && !0 === t.min
          ? (c.all || c.id == t.id) && (t.min = !1)
          : h == OrgChart.action.exporting && !1 === c.min
          ? (t.min = !1)
          : h == OrgChart.action.init && null != d && (t.min = d.min.has(t.id))
        : (c.all || c.id == t.id) && (t.min = !0),
      !t.min)
    )
      for (p = 0; p < t.stChildrenIds.length; p++) {
        f = e[t.stChildrenIds[p]]
        ;(t.tags && t.tags.has('filter')) || ((f.stParent = t), t.stChildren.push(f))
      }
    null != i && (t.level = i), r && (t.lcn = r)
    var C = OrgChart._getSubLevels(t.tags, l.tags)
    C > 0 && (t.subLevels = C), -1 != t.tags.indexOf('assistant') && null != t.parent && (t.isAssistant = !0)
    var m = OrgChart.t(t.templateName, t.min)
    ;(t.w = m && m.size ? m.size[0] : 0),
      (t.h = m && m.size ? m.size[1] : 0),
      (t.padding = m && m.padding ? m.padding : [0, 0, 0, 0])
    var O = { node: t }
    OrgChart.events.publish('node-initialized', [o, O]), OrgChart.events.publish('node-created', [t])
  }),
  (OrgChart.manager._iterate = function (t, e, r, i, a, n, o, l, s, h, c, d) {
    var g = d.manager.layoutConfigs
    if (
      (OrgChart.manager._initNode(e, r, s, i, h, c, d),
      ...
      if (e.parent && e.parent.children.length && e.parent.children[e.parent.children.length - 1] == e) {
        for (var p = [], f = 0, u = 0, C = 0; C < e.parent.children.length; C++) {
          ;-1 == (m = e.parent.children[C]).tags.indexOf('partner') &&
          -1 == m.tags.indexOf('left-partner') &&
          -1 == m.tags.indexOf('right-partner') &&
          -1 == m.tags.indexOf('assistant') &&
          0 == m.children.length
            ? p.push(m.id)
            : -1 != m.tags.indexOf('assistant')
            ? f++
            : (-1 == m.tags.indexOf('partner') &&
                -1 == m.tags.indexOf('left-partner') &&
                -1 == m.tags.indexOf('right-partner')) ||
              u++
        }
        ;((OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > 1 && p.length == e.parent.children.length - f - u) ||
          (!OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > 1)) &&
          (l[e.pid] = p)
      }
    } else if (!e.isAssistant && 0 == e.childrenIds.length && e.parent && !l[e.pid]) {
      for (p = [], f = 0, u = 0, C = 0; C < e.parent.children.length; C++) {
        var m
        ;-1 == (m = e.parent.children[C]).tags.indexOf('partner') &&
        -1 == m.tags.indexOf('left-partner') &&
        -1 == m.tags.indexOf('right-partner') &&
        -1 == m.tags.indexOf('assistant') &&
        0 == m.childrenIds.length
          ? p.push(m.id)
          : -1 != m.tags.indexOf('assistant')
          ? f++
          : (-1 == m.tags.indexOf('partner') &&
      ...
      ;((OrgChart.MIXED_LAYOUT_ALL_NODES &&
        ...
        p.length == e.parent.childrenIds.length - f - u) ||
    ...
    for (var O = 0; O < e.stChildren.length; O++) {
      var b = ''
      for (C = 0; C < e.tags.length; C++)
        if (g[e.tags[C]]) {
          b = e.tags[C]
          break
        }
      a.push(e.stChildren[O].id), OrgChart.manager._iterate(t, e.stChildren[O], r, 0, a, n, o, l, b, h, c, d)
    }
    i++
    for (O = 0; O < e.children.length; O++) OrgChart.manager._iterate(t, e.children[O], r, i, a, n, o, l, s, h, c, d)
  }),
  (OrgChart.manager.__createNodes = function (t, e, r, i, a, n, o, l) {
    for (var s = [], h = OrgChart._addDottedLines(r), c = 0; c < h.length; c++) {
      var d,
        g = h[c]
      ;(d = OrgChart.STRING_TAGS ? (g.tags ? g.tags.split(',') : []) : Array.isArray(g.tags) ? g.tags.slice(0) : []),
        l.filterUI.addFilterTag(g) && d.unshift('filter')
      var p = l.searchUI.addMatchTag(g.id)
      !0 === p ? d.unshift('match') : !1 === p && d.unshift('no-match')
      var f = OrgChart._getTemplate(d, r.tags, r.template),
        u = new OrgChart.node(g.id, g.pid, d, f)
      OrgChart.isNEU(g.ppid) || (u.ppid = g.ppid),
        OrgChart.isNEU(g.stpid) || (u.stpid = g.stpid),
        null != r.orderBy && (u.order = OrgChart.manager._getOrderFieldValue(g, r.orderBy)),
        (t[g.id] = u),
        s.push(g.id)
    }
    null != r.orderBy &&
    ...
    for (c = 0; c < s.length; c++) {
      var C = s[c],
        ...
        O = t[u.stpid],
        b = t[u.pid]
      if ((O || (u.stpid = null), b || (u.pid = null), O)) {
        var v = n ? n[O.id] : null
        v && (O.min = v.min), O.stChildrenIds.push(u.id)
      } else
        b
          ? (m && ((u.collapsed = m.collapsed), (u.min = m.min)), b.childrenIds.push(u.id))
          : (m && ((u.collapsed = m.collapsed), (u.min = m.min)), e.push(u), o.push(u.id))
  ...
  (OrgChart.manager._createNodes = function (t) {
    ...
    if ((OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t), null != e.roots)) {
      ...
      for (var c = 0; c < e.roots.length; c++) {
        ...
        if (d && i == OrgChart.action.centerNode) {
          for (var g = d; null != g.pid || null != g.stpid; )
            g = null == g.pid && null != g.stpid ? l[g.stpid] : l[g.pid]
          for (var p = l[a.id]; (null != p.pid || null != p.stpid) && p != d; )
        ...
        if (d) {
          ...
          if (!f) {
            if (!OrgChart.isNEU(d.pid))
              (D = (b = l[d.pid]).childrenIds.indexOf(d.id)) > -1 && b.childrenIds.splice(D, 1)
            s.push(d)
          }
        }
      }
    ...
    i == OrgChart.action.exporting && null != a.id && (m = l[a.id]) && ((m.pid = null), (s = [m]))
    var C = []
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
      for (c = 0; c < e.expand.nodes.length; c++) {
        var m = l[e.expand.nodes[c]]
        for (!0 === e.expand.allChildren && OrgChart.manager._addExpandedNodeIdsIterate(m, l, C); m; )
          C.push(m.id), null == m.pid && null != m.stpid ? ((m = l[m.stpid]).min = !1) : (m = l[m.pid])
      }
    else if (
      ...
      var O
      O = i == OrgChart.action.expand ? a.ids : a.expandIds
      for (c = 0; c < O.length; c++)
        for (var b = l[(m = l[O[c]]).pid]; b; )
          C.push(b.id), null == b.pid && null != b.stpid ? ((b = l[b.stpid]).min = !1) : (b = l[b.pid])
    } else if (i == OrgChart.action.centerNode) {
      for (var v = l[a.id]; v; ) {
        if ((C.push(v.id), a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && v))
          for (c = 0; c < v.childrenIds.length; c++) {
            ;(z = l[v.childrenIds[c]]).collapsed = !0
          }
    ...
    var _ = [],
      ...
      S = {},
      I = []
    for (c = 0; c < s.length; c++) OrgChart.manager._iterate(s[c], s[c], l, 0, _, w, k, S, '', C, I, t)
    if (i == OrgChart.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds))
      for (c = 0; c < a.ids.length; c++) {
        ...
        else (m = l[a.collapseIds[c]]) && (m.collapsed = !0)
      }
    ...
    for (c = 0; c < I.length; c++) {
      ...
      for (x = 0; x < N.length; x++) {
        E[(z = l[N[x]]).id] ? m.children.push(z) : m.children.splice(0, 0, z)
        for (var F = 0; F < z.childrenIds.length; F++) H.push(z.childrenIds[F])
      }
      var R = []
      for (x = 0; x < L.length; x++) {
        E[(z = l[L[x]]).id] ? m.children.push(z) : m.children.splice(0, 0, z)
        for (F = 0; F < z.childrenIds.length; F++) R.push(z.childrenIds[F])
      }
      for (x = 0; x < R.length; x++) {
        ;(z = l[R[x]]).collapsed ||
          ((z.parentPartner = z.parent), (z.parent = m), (z.isChildOfPartner = !0), m.children.push(z))
      }
      for (x = L.length - 1; x >= 0; x--)
        if (E[L[x]])
          for (u = 0; u < E[L[x]].length; u++)
            m.children.push(l[E[L[x]][u]]), P++, -1 == U.indexOf(L[x]) && U.push(L[x])
      ...
      for (x = 0; x < N.length; x++)
        if (E[N[x]])
          for (u = 0; u < E[N[x]].length; u++)
            m.children.push(l[E[N[x]][u]]), T++, -1 == B.indexOf(N[x]) && B.push(N[x])
      for (x = 0; x < H.length; x++) {
        ;(z = l[H[x]]).collapsed ||
          ((z.parentPartner = z.parent), (z.parent = m), (z.isChildOfPartner = !0), m.children.push(z))
      }
      ;(m.partnerSeparation = Math.max(U.length, B.length) * e.partnerChildrenSplitSeparation + e.minPartnerSeparation),
        A.length || !P || T
          ? A.length || P || !T
            ? A.length || 1 != P || 1 != T
              ? A.length || P || T
    ...
    for (c = 0; c < k.length; c++) {
      if ((at = r[(m = l[k[c]]).lcn ? m.lcn : 'base']).layout == OrgChart.normal || !S[m.pid])
        for (x = 0; x < m.subLevels; x++) {
          var D,
            j = new OrgChart.node(m.id + '_sub_level_index_' + x, m.pid, [], 'subLevel')
          if ((OrgChart.manager._initDinamicNode(j, m.lcn), (b = m.parent)))
            (D = b.children.indexOf(m)) > -1 && (b.children.splice(D, 1), b.children.splice(D, 0, j)),
              j.children.push(m),
              (j.parent = b),
              (m.parent = j),
              (l[j.id] = j)
    ...
    for (var Y in w) {
      ;(b = l[Y]).hasAssistants = !0
      j = new OrgChart.node(b.id + '_split_assitant_0', b.id, ['assistant'], 'split')
      OrgChart.manager._initDinamicNode(j, b.lcn, !0), (l[j.id] = j)
      var X = []
      for (x = b.children.length - 1; x >= 0; x--) {
        ;(z = b.children[x]).isAssistant
          ? ((z.parent = null), b.children.splice(x, 1), X.splice(0, 0, z.id))
          : z.isPartner ||
            (z.parent &&
              S[z.parent.id] &&
              j &&
              z.parent.id != j.id &&
              (Object.defineProperty(S, j.id, Object.getOwnPropertyDescriptor(S, z.parent.id)), delete S[z.parent.id]),
            (z.parent = j),
            j.children.unshift(z),
            b.children.splice(x, 1))
      }
      if (X.length % 2) {
        var q = l[X[X.length - 1]],
          $ = new OrgChart.node(q.id + '_mirror', b.pid, [], 'mirror')
      ...
      for (x = X.length - 1; x >= 0; x--)
        if (x % 2 && x != X.length - 1) {
          var W = new OrgChart.node(b.id + '_split_assitant_' + V, b.pid, [], 'split')
          OrgChart.manager._initDinamicNode(W, b.lcn, !0), (l[W.id] = W), X.splice(x, 0, W.id), V++
      ...
      for (x = 0; x < X.length; x += 3) {
        ...
        var J = l[X[x]],
          K = l[X[x + 1]],
          Z = l[X[x + 2]]
        ;(J.parent = G), (K.parent = G), (Z.parent = G), G.children.push(J), G.children.push(K), G.children.push(Z)
      }
    }
    var Q = !1
    for (var tt in r) {
    ...
    if (Q || et) {
      ...
      for (var Y in S) {
        for (var it = (b = l[Y]); it.isSplit; ) it = l[it.pid]
        var at
        if (
          (at = r[b.lcn ? b.lcn : 'base']).layout == OrgChart.mixed ||
          at.layout == OrgChart.tree ||
          at.layout == OrgChart.treeRightOffset ||
          at.layout == OrgChart.treeLeftOffset ||
          et
          ...
          if (
            ...
            for (c = nt.length - 1; c >= 0; c--) {
              ;(b = (z = l[nt[c]]).parent), (z.layout = OrgChart.mixed)
              for (x = b.children.length - 1; x >= 0; x--)
                if (z.id == b.children[x].id) {
                  b.children.splice(x, 1)
                  break
                }
              if (c > 0) {
                var ot = l[nt[c - 1]]
                ;(z.parent = ot), (z.layout = OrgChart.mixed), ot.children.push(z)
            ...
            j = new OrgChart.node(b.id + '_split_0', it.id, [], 'split')
            OrgChart.manager._initDinamicNode(j, b.lcn), (l[j.id] = j), (j.layout = OrgChart.tree)
            var lt = []
            for (c = rt.childrenIds.length - 1; c >= 0; c--) {
              for (z = l[rt.childrenIds[c]], x = 0; x < b.children.length; x++)
                b.children[x].id == z.id && b.children.splice(x, 1)
              if (
                ((z.parent = null),
                (z.layout = OrgChart.tree),
                rt.layout == OrgChart.treeRightOffset && lt.splice(0, 0, z.id),
                rt.layout == OrgChart.treeLeftOffset || rt.layout == OrgChart.treeRightOffset)
              ) {
                var st = new OrgChart.node(z.id + '_mirror', it.id, [], 'mirror')
                OrgChart.manager._initDinamicNode(st, z.lcn),
            ...
            for (V = 1, x = lt.length - 1; x >= 0; x--)
              if (x % 2 && x != lt.length - 1) {
                W = new OrgChart.node(b.id + '_split_' + V, it.id, [], 'split')
                OrgChart.manager._initDinamicNode(W, b.lcn),
                  (W.layout = OrgChart.tree),
                  (l[W.id] = W),
                  lt.splice(x, 0, W.id),
                  V++
            ...
            for (x = 0; x < lt.length; x += 3) {
              ...
              0 != x && (G = l[lt[x - 3]]),
                ...
                (J.parent = G),
                G.children.push(J),
                K && (0 != x && (G = l[lt[x - 2]]), (K.parent = G), G.children.push(K)),
                Z && (0 != x && (G = l[lt[x - 1]]), (Z.parent = G), G.children.push(Z))
            }
          }
      }
    }
    ...
    rt = { nodes: l, roots: s }
    return OrgChart.events.publish('nodes-initialized', [t, rt]), { nodes: rt.nodes, roots: rt.roots, rootList: h }
  }),
  ...
  (OrgChart.manager._getResponse = function (t, e, r, i, a, n, o, l, s, h, c, d, g, p, f) {
    var u = h[0],
      ...
      b = a - o + 2 * i.padding,
      v = n - l + 2 * i.padding,
      x = OrgChart.getScale(s, t, e, i.scaleInitial, i.scaleMax, i.scaleMin, b, v)
    if (
      ((m.top = l - i.padding),
      (m.left = o - i.padding),
      (m.bottom = n + i.padding - e / x),
      (m.right = a + i.padding - t / x),
      (m.maxX = a),
      (m.minX = o),
      (m.maxY = n),
      (m.minY = l),
      ...
      if (y - 2 * i.padding >= a - o)
        ...
        switch (((w = u.x - y / 2 + OrgChart.manager._getNodeWidth(u, i) / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
      ...
      switch (i.orientation) {
        case OrgChart.orientation.top:
          ;(w = u.x - y / 2 + OrgChart.manager._getNodeWidth(u, i) / 2), (k = -i.padding)
          break
        case OrgChart.orientation.bottom:
          ;(w = u.x - y / 2 + OrgChart.manager._getNodeWidth(u, i) / 2), (k = i.padding - _)
          break
        case OrgChart.orientation.left:
          ;(w = -i.padding), (k = u.y - _ / 2 + OrgChart.manager._getNodeWidth(u, i) / 2)
          break
        case OrgChart.orientation.right:
          ;(w = i.padding - y), (k = u.y - _ / 2 + OrgChart.manager._getNodeWidth(u, i) / 2)
          break
        case OrgChart.orientation.top_left:
    ...
    if (
      c == OrgChart.action.insert ||
      c == OrgChart.action.expand ||
      c == OrgChart.action.collapse ||
      c == OrgChart.action.update ||
      c == OrgChart.action.centerNode ||
      c == OrgChart.action.maximize
    ) {
      var I = null
      if (c == OrgChart.action.insert && d && null != d.insertedNodeId && null != d.insertedNodeId)
        ...
        (c != OrgChart.action.expand && c != OrgChart.action.collapse && c != OrgChart.action.maximize) ||
        !d ||
        null == d.id ||
        null == d.id
      ) {
    ...
    for (var N = 0; N < h.length; N++) OrgChart.manager._iterate2(h[N], g, i, s, c, d, C, p, r, O)
    return {
      animations: O,
      boundary: m,
      viewBox: s,
  ...
  (OrgChart.manager._iterate2 = function (t, e, r, i, a, n, o, l, s, h) {
    if (OrgChart.manager._isVisible(t, r, i, a)) {
      ...
      var c = null
      if (
        (a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) &&
        l &&
        l[t.id] &&
        'expandCollapseToLevel' == n.method
      ) {
        if (((c = { x: (f = l[t.id]).x, y: f.y }), f)) {
          c = { x: f.x, y: f.y }
        ...
        if ((u = e[n.id])) {
          ...
          d && (c = { x: u.x + u.w / 2 - t.w / 2, y: u.y + u.h / 2 - t.h / 2 })
        }
      } else if ((a == OrgChart.action.expand || a == OrgChart.action.collapse) && l && l[t.id]) {
        if (((c = { x: (f = l[t.id]).x, y: f.y }), 'all' == n.ids && f)) {
          c = { x: f.x, y: f.y }
      ...
      null != c &&
        ...
        ((c.x == t.x && c.y == t.y) ||
          (h[0].push(t.id),
          h[1].push({ transform: [1, 0, 0, 1, c.x, c.y] }),
          h[2].push({ transform: [1, 0, 0, 1, t.x, t.y] })))
    }
    for (var C = 0; C < t.stChildren.length; C++) OrgChart.manager._iterate2(t.stChildren[C], e, r, i, a, n, o, l, s, h)
    for (C = 0; C < t.children.length; C++) OrgChart.manager._iterate2(t.children[C], e, r, i, a, n, o, l, s, h)
  }),
  (OrgChart.manager._addExpandedNodeIdsIterate = function (t, e, r) {
    for (var i = 0; i < t.childrenIds.length; i++)
      r.push(t.childrenIds[i]), OrgChart.manager._addExpandedNodeIdsIterate(e[t.childrenIds[i]], e, r)
  }),
  ...
  (OrgChart.manager._doNotChangePositionOfClickedNodeIfAny = function (t, e, r, i, a, n) {
    ...
    var o = i.id
    ;((r == OrgChart.action.minimize && e[o].parent) || (r == OrgChart.action.maximize && e[o].parent)) &&
      (o = e[o].pid)
    var l = e[o],
      s = a[o]
  ...
  (OrgChart.manager._verticalAssistantIterate = function (t, e) {
    ...
    if (t.isAssistant && t.isSplit && t.children.length) {
      ...
      for (r = 0; r < s; r++) {
        ...
        OrgChart.manager._initDinamicNode(c, t.lcn, !0),
          r > 0 && (h[r - 1].children.push(c), (c.parent = h[r - 1])),
          (e[c.id] = c),
          h.push(c)
      }
      if (h.length) {
        for (var d = h[h.length - 1], g = h[0], p = t.children.length - 1; p >= 0; p--) {
          var f = t.children[p]
          d.children.unshift(f), (f.parent = d), t.children.splice(p, 1)
        }
  ...
  (OrgChart._addDottedLines = function (t) {
    var e = t.nodes
    if (
      ((t.groupDottedLines.length || t.dottedLines.length) && (e = JSON.parse(JSON.stringify(e))),
      ...
      for (var r = [], i = 0; i < t.groupDottedLines.length; i++) {
        ...
        if (!r.has(n))
          for (var o = 0; o < e.length; o++)
            if (e[o].id == a.rootId) {
              ;((c = JSON.parse(JSON.stringify(e[o]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${e[o].id}`),
                (c.pid = void 0),
                (c.stpid = e[o].id),
                e.push(c),
                r.push(n),
        ...
        for (o = 0; o < e.length; o++)
          if (e[o].id == a.from) {
            ...
            if ((c.tags || (c.tags = []), c.tags.push('boc-dotted-connector'), a.tags))
      ...
      for (i = 0; i < t.dottedLines.length; i++) {
        ...
        for (o = 0; o < e.length; o++)
          if (e[o].id == h.from) {
            var c
            if (
              (((c = JSON.parse(JSON.stringify(e[o]))).id = `balkan_dotted_${h.rootId}_balkan_id_${e[o].id}`),
              h.rootId == h.to ? (c.pid = h.to) : (c.pid = `balkan_dotted_${h.rootId}_balkan_id_${h.to}`),
              c.tags || (c.tags = []),
              c.tags.push('boc-dotted-connector'),
              h.tags)
            )
              for (s = 0; s < h.tags.length; s++) c.tags.push(h.tags[s])
            e.push(c)
            break
          }
      }
  ...
  (OrgChart.templates.ula.field_0 =
    '<text ' + OrgChart.attr.width + '="145" style="font-size: 18px;" fill="#039BE5" x="100" y="55">{val}</text>'),
  ...
  (OrgChart.ui = {
    ...
    lonely: function (t) {
      return t.nodes && t.nodes.length
        ? ''
        : OrgChart.IT_IS_LONELY_HERE.replace('{link}', OrgChart.RES.IT_IS_LONELY_HERE_LINK)
    },
    ...
    node: function (t, e, r, i, a, n, o, l, s, h) {
      ...
      for (var p in o) {
        var f,
          u = o[p]
        e && (f = e[u])
        var C = OrgChart._lblIsImg(i, p)
        if (
          ((g.value = f),
          (g.element = c[p]),
          (g.name = u),
          (g.field = p),
          !1 !== OrgChart.events.publish('field', [h, g]) && null != g.value && null != g.value && null != g.element)
        ) {
          if (!C && 'string' == typeof g.value) {
            var m = g.element
            m && (m = m.replaceAll('{ew}', t.w - (t.padding ? t.padding[1] : 0)).replaceAll('{cw}', t.w / 2)),
              (g.value = OrgChart.wrapText(g.value, m))
          }
          var O = g.element.replace('{val}', g.value)
          d += O = O.replaceAll('{ew}', t.w - (t.padding ? t.padding[1] : 0))
            .replaceAll('{cw}', t.w / 2)
      ...
      return (d = (y = y.replace('{opacity}', _)) + (d += OrgChart.ui.nodeBtns(i, t, l, c, h)) + OrgChart.grCloseTag)
    },
        ...
        if (e.childrenIds.length > 0) {
          ...
          if (
            ...
            t.getCollapsedIds(e).length
              ? ((n += OrgChart.expcollOpenTag.replace('{id}', e.id).replace('{x}', l).replace('{y}', s)),
                (n += h.plus),
          ...
          if (-1 != n.indexOf('{collapsed-children-total-count}')) {
            var f = OrgChart.collapsedChildrenTotalCount(t, e)
            n = n.replace('{collapsed-children-total-count}', f)
          }
          if (-1 != n.indexOf('{children-count}')) {
            var u = OrgChart.childrenCount(t, e)
            n = n.replace('{children-count}', u)
          }
          if (-1 != n.indexOf('{children-total-count}')) {
            var C = OrgChart.childrenTotalCount(t, e)
            n = n.replace('{children-total-count}', C)
          }
        }
        t._nodeHasHiddenParent(e) &&
          ((n += OrgChart.upOpenTag.replace('{id}', e.id).replace('{x}', e.x).replace('{y}', e.y)),
          (n += h.up),
          (n += OrgChart.grCloseTag))
      }
      var m = { html: n, node: e }
      return OrgChart.events.publish('renderbuttons', [t, m]), m.html
    },
    link: function (t, e, r, i, a, n) {
      ...
      if (t.hasPartners) {
        ...
        for (var u = 0; u < t.children.length; u++) {
          ;(C = t.children[u]).parentPartner
            ? ((f.ppnodes[C.id] = C.parentPartner),
              f.ids.push(C.id),
              1 == C.parentPartner.isPartner
                ? (-1 == f.rightIds.indexOf(C.parentPartner.id) && f.rightIds.push(C.parentPartner.id),
                  (f.indexes[C.id] = f.rightIds.indexOf(C.parentPartner.id)),
                  f.firstRight || (f.firstRight = C))
                : 2 == C.parentPartner.isPartner &&
                  (-1 == f.leftIds.indexOf(C.parentPartner.id) && f.leftIds.push(C.parentPartner.id),
                  (f.indexes[C.id] = f.leftIds.indexOf(C.parentPartner.id)),
                  (f.lastLeft = C)))
            : C.isPartner || ((f.lastLeft = C), f.firstRight || (f.firstRight = C))
        }
      ...
      for (u = 0; u < t.children.length; u++) {
        var C = t.children[u],
          m = i[g][C.sl],
          O = { xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0 },
          b = (s = OrgChart.t(C.templateName, C.min, r)).link
        if (C.isChildOfPartner)
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              var v = 1 == C.layout ? void 0 : m.minY - (m.minY - p.maxY) / 2
              O = OrgChart.ui._linkTopToBottom(C.parentPartner, C, s, c, v)
              break
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              v = 1 == C.layout ? void 0 : m.maxY - (m.maxY - p.minY) / 2
              O = OrgChart.ui._linkBottomToTop(C.parentPartner, C, s, c, v)
              break
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              v = 1 == C.layout ? void 0 : m.maxX - (m.maxX - p.minX) / 2
              O = OrgChart.ui._linkRightToLeft(C.parentPartner, C, s, c, v)
              break
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              v = 1 == C.layout ? void 0 : m.minX - (m.minX - p.maxX) / 2
              O = OrgChart.ui._linkLeftToRight(C.parentPartner, C, s, c, v)
          }
        else if (f && -1 != f.ids.indexOf(C.id))
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              O = OrgChart.ui._linkPpTop(f, t, C, m, p, s)
              break
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              O = OrgChart.ui._linkPpBottom(f, t, C, m, p, s)
              break
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              O = OrgChart.ui._linkPpRight(f, t, C, m, p, s)
              break
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              O = OrgChart.ui._linkPpLeft(f, t, C, m, p, s)
          }
        else {
          var x = C.isAssistant && C.rightNeighbor && C.rightNeighbor.isAssistant && C.parent == C.rightNeighbor.parent,
            y = C.isAssistant && C.leftNeighbor && C.leftNeighbor.isAssistant && C.parent == C.leftNeighbor.parent
          if ((x || 2 == C.layout) && C.rightNeighbor && C.rightNeighbor.isSplit)
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                O = OrgChart.ui._linkRightToLeft(C.rightNeighbor, C, s, c)
                break
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                O = OrgChart.ui._linkBottomToTop(C.rightNeighbor, C, s, c)
            }
          else if ((y || 2 == C.layout) && C.leftNeighbor && C.leftNeighbor.isSplit)
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                O = OrgChart.ui._linkLeftToRight(C.leftNeighbor, C, s, c)
                break
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                O = OrgChart.ui._linkTopToBottom(C.leftNeighbor, C, s, c)
            }
          else
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
                if (1 == C.isPartner) O = OrgChart.ui._linkLeftToRight(t, C, s, d)
                else if (2 == C.isPartner) O = OrgChart.ui._linkRightToLeft(t, C, s, d)
                else {
                  v = 1 == C.layout ? void 0 : m.minY - (m.minY - p.maxY) / 2
                  O = OrgChart.ui._linkTopToBottom(t, C, s, c, v)
                }
                break
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                if (1 == C.isPartner) O = OrgChart.ui._linkLeftToRight(t, C, s, d)
                  ...
                  v = 1 == C.layout ? void 0 : m.maxY - (m.maxY - p.minY) / 2
                  O = OrgChart.ui._linkBottomToTop(t, C, s, c, v)
                }
                break
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
                if (1 == C.isPartner) O = OrgChart.ui._linkTopToBottom(t, C, s, d)
                else if (2 == C.isPartner) O = OrgChart.ui._linkBottomToTop(t, C, s, d)
                else {
                  v = 1 == C.layout ? void 0 : m.maxX - (m.maxX - p.minX) / 2
                  O = OrgChart.ui._linkRightToLeft(t, C, s, c, v)
                }
                break
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                if (1 == C.isPartner) O = OrgChart.ui._linkTopToBottom(t, C, s, d)
                  ...
                  v = 1 == C.layout ? void 0 : m.minX - (m.minX - p.maxX) / 2
                  O = OrgChart.ui._linkLeftToRight(t, C, s, c, v)
                }
            }
        }
        if (-1 != b.indexOf('{rounded}'))
          if ((O.xa == O.xb && O.xa == O.xc && O.xa == O.xd) || (O.ya == O.yb && O.ya == O.yc && O.ya == O.yd))
            b = b.replace('{rounded}', 'M' + O.xa + ',' + O.ya + ' L' + O.xd + ',' + O.yd)
          else if (
            Math.abs(O.xa - O.xd) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(O.xa - O.xc) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(O.xa - O.xb) <= OrgChart.LINK_ROUNDED_CORNERS
          )
            b = b.replace('{rounded}', 'M' + O.xa + ',' + O.ya + ' L' + O.xa + ',' + O.yd)
          else if (
            Math.abs(O.ya - O.yd) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(O.ya - O.yc) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(O.ya - O.yb) <= OrgChart.LINK_ROUNDED_CORNERS
          )
            b = b.replace('{rounded}', 'M' + O.xa + ',' + O.ya + ' L' + O.xd + ',' + O.ya)
          else {
            var _ = OrgChart.ui._roundedEdge(O.xa, O.ya, O.xb, O.yb, O.xc, O.yc),
              w = OrgChart.ui._roundedEdge(O.xb, O.yb, O.xc, O.yc, O.xd, O.yd)
            b = b.replace(
              '{rounded}',
              'M' +
                _.x1 +
          ...
          b =
            -1 != b.indexOf('{edge}')
              ? b.replace(
                  '{edge}',
                  'M' + O.xa + ',' + O.ya + ' ' + O.xb + ',' + O.yb + ' ' + O.xc + ',' + O.yc + ' L' + O.xd + ',' + O.yd
                )
              : -1 != b.indexOf('{curve}')
              ? b.replace(
                  '{curve}',
                  'M' + O.xa + ',' + O.ya + ' C' + O.xb + ',' + O.yb + ' ' + O.xc + ',' + O.yc + ' ' + O.xd + ',' + O.yd
                )
              : b
                  .replaceAll('{xa}', O.xa)
                  .replaceAll('{ya}', O.ya)
        ...
        h.push(
          OrgChart.linkOpenTag
            .replace('{id}', t.id)
            .replace('{class}', 'link ' + C.tags.join(' '))
            .replace('{child-id}', C.id)
        )
        var k = { node: t, cnode: C, p: O, html: b, action: n }
          ...
          if (N) {
            ...
            ;(k.value = L),
              ...
              !1 !== OrgChart.events.publish('label', [e, k]) &&
                (OrgChart.isNEU(k.value) || OrgChart.isNEU(k.element) || (S += k.element.replace('{val}', k.value)))
          }
        }
        '' != S &&
          ((S =
            OrgChart.linkFieldsOpenTag.replace('{x}', O.x).replace('{y}', O.y).replace('{rotate}', 0) +
            S +
            OrgChart.grCloseTag),
          h.push(S)),
    ...
    _roundedEdge: function (t, e, r, i, a, n) {
      ...
      return (
        (t == r && t == a) || (e == i && e == n)
          ? ((o = s = r), (l = c = i))
          : (t != a && r == a && ((o = s = r), (l = i), e < n ? (c = i + h) : e > n && (c = i - h)),
            t < a && r == a ? (r -= h) : t > a && r == a && (r += h),
            e != n && i == n && ((o = r), (l = c = i), t < a ? (s = r + h) : t > a && (s = r - h)),
            e < n && i == n ? (i -= h) : e > n && i == n && (i += h)),
        { x1: t, y1: e, x2: r, y2: i, x3: a, y3: n, qx1: o, qy1: l, qx2: s, qy2: c }
      )
    },
    _linkTopToBottom: function (t, e, r, i, a) {
      ...
      return (
        ...
        (h = e.y + r.linkAdjuster.fromY),
        {
          ...
          yd: h,
          x: l,
          y: OrgChart.isNEU(e.parentPartner) ? c + 16 : c,
          rotate: 0
        }
      )
    },
    ...
    if (OrgChart.isObject(t) && OrgChart.isObject(e))
      for (var r in e)
        OrgChart.isObject(e[r])
          ? (t[r] || Object.assign(t, { [r]: {} }), OrgChart.mergeDeep(t[r], e[r]))
  ...
  (OrgChart.wrapText = function (t, e) {
    ...
    d || (d = 'ellipsis')
    var f = d.split('-')
    if ((f.length > 1 && ((a = parseInt(d.split('-')[1])), f.length > 2 && 'ellipsis' == f[2] && (n = !0)), !c))
    ...
    if (((c = parseFloat(c)), l || (l = 0), s || (s = 0), l || (h = 'start'), 'ellipsis' == d)) {
      ...
      for (var u = p.getComputedTextLength(), C = 2; u > c; )
        (p.textContent = t.substring(0, t.length - C)), (p.textContent += '...'), (u = p.getComputedTextLength()), C++
      return C > 2 ? `<title>${OrgChart._escapeHtml(t)}</title>${p.textContent}` : OrgChart._escapeHtml(t)
    }
    if (-1 != d.indexOf('multiline')) {
      ...
      b.setAttributeNS(null, 'x', l),
        ...
        p.appendChild(b)
      C = 1
      for (var x = 1, y = 1; y < m.length; y++) {
        var _ = b.firstChild.data.length
        if (((b.firstChild.data += ' ' + m[y]), b.getComputedTextLength() > c)) {
          if (((b.firstChild.data = b.firstChild.data.slice(0, _)), x++, a && x > a)) {
          ...
          ;(b = document.createElementNS(g, 'tspan')).setAttributeNS(null, 'x', l),
            b.setAttributeNS(null, 'y', s + O * C),
            b.setAttributeNS(null, 'text-anchor', h),
            (v = document.createTextNode(m[y])),
            b.appendChild(v),
            p.appendChild(b),
            C++
        }
      ...
      if (null != p.innerHTML) (k = p.innerHTML), (p.innerHTML = '')
        ...
        for (y = p.childNodes.length - 1; y >= 0; y--)
          (S = XMLSerializer().serializeToString(p.childNodes[y]) + S), p.removeChild(p.childNodes[y])
        k = S
      }
      return k
    }
  ...
  (OrgChart._getPosition = function (t, e, r, i) {
    ...
    if ((null != r && (a.x = r), null != i && (a.y = r), t && 3 == t.length)) {
      ...
      ;-1 != n &&
        ...
        (null == r && (a.x = t[1][n].transform[4]), null == i && (a.y = t[1][n].transform[5]))
    }
    return a
  }),
  ...
  (OrgChart._json2xml = function (t) {
    for (
      var e = document.implementation.createDocument('', '', null), r = e.createElement('nodes'), i = 0;
      i < t.length;
      i++
    ) {
  ...
  (OrgChart._xml2json = function (t) {
    for (
      var e = new DOMParser().parseFromString(t, 'text/xml').getElementsByTagName('node'), r = [], i = 0;
      i < e.length;
      i++
    ) {
      ...
      var e = [],
        r = function (t) {
          for (var r = '', i = 0; i < e.length; i++) {
            var a
            ;(a = 'reportsTo' == e[i] ? null : null == t[e[i]] ? '' : t[e[i]]) instanceof Date &&
              (a = a.toLocaleString())
  ...
  (OrgChart.accentFold = function (t) {
    return (t = t.toString().toLowerCase()).replace(
      ...
      function (t, e, r, i, a, n, o, l, s, h, c) {
        return e
          ? 'a'
          : r
          ? 'c'
  ...
  (OrgChart.copy = function (t) {
    ...
    for (var r in t)
      Object.prototype.hasOwnProperty.call(t, r) &&
        ((t.isActiveClone = null), (e[r] = OrgChart.copy(t[r])), delete t.isActiveClone)
    return e
  }),
  ...
  (OrgChart.xScrollUI.prototype.addListener = function (t) {
    var e = this
    if (
      (this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) &&
      this.bar
    ) {
        ...
        t.addEventListener(
          ...
          function (t) {
            ...
            if (e.config.mouseScrool == OrgChart.action.xScroll)
              ...
              !(i = t.shiftKey ? t.deltaY || t.wheelDeltaY : t.deltaX || t.wheelDeltaX)
            )
              return
        ...
        t.addEventListener(
          ...
          function (t) {
            ...
            if (e.config.mouseScrool == OrgChart.action.yScroll)
              ...
              e.config.mouseScrool == OrgChart.action.scroll &&
              !(i = t.shiftKey ? t.deltaX || t.wheelDeltaX : t.deltaY || t.wheelDeltaY)
            )
              return
            ;(i = -i), (i = Math.max(-1, Math.min(1, i))), (e.pos += -i * r)
  ...
  (OrgChart.prototype.zoom = function (t, e, r, i) {
    var a = this.getViewBox().slice(0),
      ...
      l = a[3]
    !0 === t
      ? ((a[2] = a[2] / OrgChart.SCALE_FACTOR), (a[3] = a[3] / OrgChart.SCALE_FACTOR))
      : !1 === t
      ? ((a[2] = a[2] * OrgChart.SCALE_FACTOR), (a[3] = a[3] * OrgChart.SCALE_FACTOR))
      : ((a[2] = a[2] / t), (a[3] = a[3] / t)),
      e || (e = [50, 50]),
    ...
    if (
      ...
      (!0 === t && s < this.config.scaleMax) ||
        ...
        (0 != t && 1 != t && s < this.config.scaleMax && s > this.config.scaleMin))
    ) {
  ...
  (OrgChart.pdfPrevUI._handler = function (t, e, r) {
    ...
    for (var s = l.querySelector('svg'), h = t.element.querySelector('#boc-ppdf-content'), c = 0; c < a.length; c++) {
      ...
      Object.assign(d.style, {
        ...
        s && s.style.backgroundColor
          ? (d.style.backgroundColor = s.style.backgroundColor)
      ...
      a[c].footer && (f = a[c].footer),
        ...
        a[c].html
          ? g.write(
              OrgChart._exportHtml(a[c].html, e.styles, i, a[c].innerSize.w, a[c].innerSize.h, p, f, t.config.mode)
            )
          : (s.setAttribute('viewBox', a[c].vb),
            g.write(
              OrgChart._exportHtml(l.innerHTML, e.styles, i, a[c].innerSize.w, a[c].innerSize.h, p, f, t.config.mode)
            ))
      var u = g.getElementById('boc-header'),
        C = g.getElementById('boc-footer')
      if (u) {
    ...
    OrgChart.animate(b, { opacity: 0 }, { opacity: 1 }, 300, OrgChart.anim.outSin)
  }),
  ...
  (OrgChart.prototype._clink = function (t, e) {
    for (var r, i, a, n, o, l = '', s = 0; s < this.config.clinks.length; s++) {
      ...
      if (c && -1 != e.res.visibleNodeIds.indexOf(c.id) && d && -1 != e.res.visibleNodeIds.indexOf(d.id)) {
        ...
        var I = 'M' + C.x + ',' + C.y + 'C' + C.x + ',' + C.y + ' ' + _.x + ',' + _.y + ' ' + m.x + ',' + m.y
        ;(l +=
          ('<g ' + OrgChart.attr.c_link_from + '="{from}" ' + OrgChart.attr.c_link_to + '="{to}">')
            .replace('{from}', c.id)
            .replace('{to}', d.id) +
  ...
  (OrgChart.prototype._slinks = function (t, e) {
    ...
    function n(e, n, o) {
      ...
      var p = OrgChart.t(e.templateName, e.min, i),
        f = g.levelSeparation
      ;((e.parent && e.parent.layout == OrgChart.mixed) || (e.parent && e.parent.layout == OrgChart.tree)) &&
        (f = g.mixedHierarchyNodesSeparation)
      var u = {
      ...
      if (e.sl == n.sl)
        ...
        switch (g.orientation) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            s.push([u.p, u.q]), s.push([u.r, e.y - f / 3])
            break
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            ;(u.q = e.y + e.h), (u.s = a.maxY - f), s.push([u.p, u.q]), s.push([u.r, e.y + e.h + f / 3])
            break
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            ;(u.p = e.x),
        ...
        for (var C = e; null == h; ) {
          ...
          if (
            (O.id == n.id
              ? (h = O)
              : OrgChart._intersects(O, u, t.config) && ((u = OrgChart._addPoint(O, s, t.config, u, c)), (m = !0)),
            O.id != n.id)
          ) {
            for (; b; ) {
              if (b.id == n.id) {
              ...
              OrgChart._intersects(b, u, t.config) && ((u = OrgChart._addPoint(b, s, t.config, u, c)), (m = !0)),
                (b = b.leftNeighbor)
            }
            for (; v; ) {
              if (v.id == n.id) {
              ...
              OrgChart._intersects(v, u, t.config) && ((u = OrgChart._addPoint(v, s, t.config, u, c)), (m = !0)),
                (v = v.rightNeighbor)
            }
          }
          if (!m) {
            ...
            if (O.parent)
              switch (
                ((f = g.levelSeparation),
                (O.parent.layout != OrgChart.mixed && O.parent.layout != OrgChart.tree) ||
                  (f = g.mixedHierarchyNodesSeparation),
                g.orientation)
              ) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                  y = O.parent.y + O.parent.h + f * (2 / 3)
                  break
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                  y = O.parent.y - f * (2 / 3)
                ...
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                  ;(x = O.parent.x + O.parent.w + f * (2 / 3)), (y = s[s.length - 1][1])
                  break
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                  ;(x = O.parent.x - f * (2 / 3)), (y = s[s.length - 1][1])
              }
            s.push([x, y])
          }
          C = O
      ...
      switch ((p = OrgChart.slinkTemplates[_]).labelPosition) {
        ...
        case 'middle':
          ...
          ;(w = s[I]), (k = s[I - 1]), (S = { x: (w[0] + k[0]) / 2, y: (w[1] + k[1]) / 2 })
          break
        case 'end':
      ...
      o && ((P = n.id), (T = e.id)),
        (r +=
          ('<g ' + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">')
            .replace('{from}', P)
            .replace('{to}', T) +
          p.link.replaceAll('{d}', N) +
          '<path stroke="transparent" stroke-width="15" fill="none" d="' +
          N +
          '" />'),
    ...
    if (e.node && e.node.tags && e.node.tags.has('group-dotted-lines')) {
      ...
      e.node.min
        ? (i.nodeGroupDottedOpenButton ||
            console.error(`[${e.node.templateName}].nodeGroupDottedOpenButton is not defined`),
        ...
        : (i.nodeGroupDottedCloseButton ||
            console.error(`[${e.node.templateName}].nodeGroupDottedCloseButton is not defined`),
    ...
    if (t.config.miniMap) {
      if (t.manager.action != OrgChart.action.move) {
        ;(OrgChart.miniMap._settings._scale = Math.min(
          OrgChart.miniMap.width / (t.response.boundary.maxX - t.response.boundary.minX),
          OrgChart.miniMap.height / (t.response.boundary.maxY - t.response.boundary.minY)
        )),
          (OrgChart.miniMap._settings._translateX =
            -t.response.boundary.minX * OrgChart.miniMap._settings._scale +
            (OrgChart.miniMap.width -
              (t.response.boundary.maxX - t.response.boundary.minX) * OrgChart.miniMap._settings._scale) /
              2),
          (OrgChart.miniMap._settings._translateY =
            -t.response.boundary.minY * OrgChart.miniMap._settings._scale +
            (OrgChart.miniMap.height -
              (t.response.boundary.maxY - t.response.boundary.minY) * OrgChart.miniMap._settings._scale) /
              2)
        var r = t.getViewBox()
        ...
        ;(l.onmousedown = function (t) {
          var e,
            ...
            d = h.top
          if (
            ((i = parseInt(t.clientX - c)),
            (a = parseInt(t.clientY - d)),
            (e = a),
          ...
          (l.onmousemove = function (e) {
            if (s) {
              ...
              var p = (n - i) / OrgChart.miniMap._settings._scale,
                f = (o - a) / OrgChart.miniMap._settings._scale
              ;(r[0] = p + r[0]),
                (r[1] = f + r[1]),
                t.setViewBox(r),
      ...
      var c = t.element.querySelector('[data-id="mini-map"]')
  ...
  (OrgChart._search.search = function (t, e, r, i, a, n, o) {
    ...
    for (var d = {}, g = 0; g < t.length; g++)
      for (var p = t[g], f = 0; f < r.length; f++) {
        var u = r[f]
        if (!OrgChart.isNEU(p[u])) {
          var C = p[u]
          if (null != (e = OrgChart._search.searchAndComputeScore(h, C, u, n))) {
            var m = p.id
            if (d[m]) {
              if (d[m] && d[m] < e.__score) {
                d[m] = e.__score
                for (var O = l.length - 1; O >= 0; O--) l[O].id == m && l.splice(O, 1)
                OrgChart._search.addNodeToResult(l, i, p, e, u, a)
              }
            } else (d[m] = e.__score), OrgChart._search.addNodeToResult(l, i, p, e, u, a)
          }
        }
      }
    return (
  ...
  (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
    ...
    i && i[r] && (m = i[r]),
      ...
      h > 0 && (h = (h / 100) * 10),
      m > 0 && (m = (m / 100) * 20)
    var O = Math.round(1e4 * (f + u + C + h + m))
    n.sort(function (t, e) {
      return t.start < e.start ? -1 : t.start > e.start ? 1 : 0
    })
    var b = e
    for (p = n.length - 1; p >= 0; p--)
      b = (b = b.insert(n[p].start + n[p].length, '</mark>')).insert(n[p].start, '<mark>')
      ...
      for (var i = 0; i < e.length; i++) {
        ...
        if (!OrgChart.isNEU(a))
          for (var n = 0; (n = t.indexOf(a, n)) > -1; )
            r.push({ length: a.length, start: n, searchPhrase: a }), (n += a.length)
      }
    return (
      r.sort(function (t, e) {
    ...
    if (t.config.state) {
      ...
      !(function t(e) {
        if (Array.isArray(e)) for (var a = 0; a < e.length; a++) t(e[a])
          ...
          ;('string' != typeof e.id ||
            ('string' == typeof e.id && -1 == e.id.indexOf('split') && -1 == e.id.indexOf('mirror'))) &&
  ...
  (OrgChart.state._put = function (t, e, r, i, a, n, o, l) {
    if (l) {
      ...
      if (l.writeToUrlParams) {
        ...
        c.has(s.paramScale) ? c.set(s.paramScale, h.scale) : c.append(s.paramScale, h.scale),
          c.has(s.paramX) ? c.set(s.paramX, h.x) : c.append(s.paramX, h.x),
          c.has(s.paramY) ? c.set(s.paramY, h.y) : c.append(s.paramY, h.y),
          c.has(s.paramExp) ? c.set(s.paramExp, h.exp.join('*')) : c.append(s.paramExp, h.exp.join('*')),
          c.has(s.paramRoots) && Array.isArray(h.roots)
            ? c.set(s.paramRoots, h.roots.join('*'))
            : Array.isArray(h.roots) && c.append(s.paramRoots, h.roots.join('*')),
          c.has(s.paramMin) ? c.set(s.paramMin, h.min.join('*')) : c.append(s.paramMin, h.min.join('*')),
          c.has(s.paramAdjustify)
            ? c.set(s.paramAdjustify, h.adjustify.x + '*' + h.adjustify.y)
            : c.append(s.paramAdjustify, h.adjustify.x + '*' + h.adjustify.y),
  ...
  OrgChart.events.on('init', function (t, e) {
    if (
      ...
      var r = t.roots[0].id
      OrgChart.isNEU(t.config.keyNavigation.focusId) || (r = t.config.keyNavigation.focusId),
    ...
    if (r) {
      ...
      if (!1 !== OrgChart.events.publish('key-down', [this, n]) && a)
        if ('KeyF' == e.code) this.searchUI.find('')
          ...
          a.childrenIds.length && ((this._keyNavigationActiveNodeId = a.childrenIds[0]), this.center(a.childrenIds[0]))
  ...
  (OrgChart._keyNavigation = function (t) {
    ...
    if (
      ...
      if ((OrgChart.events.publish('screen-reader-text', [t, n]), !OrgChart.isNEU(n.text)))
        ((a = document.createElementNS('http://www.w3.org/2000/svg', 'title')).innerHTML = n.text), i.appendChild(a)
    ...
    return (
      e.btn && (n = `<a href="#" data-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`),
      {
        html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${
          a.disabledAttribute
        } ${a.vlidators}>\n                        <label for="${a.id}">${OrgChart._escapeGreaterLessSign(
          a.label
        )}</label>\n                        <input ${a.readOnlyAttribute} data-binding="${OrgChart._escapeDoubleQuotes(
          a.binding
        )}" maxlength="256" id="${a.id}" name="${a.id}" type="text" value="${OrgChart._escapeDoubleQuotes(
          a.value
        )}" autocomplete="off">\n                        ${n}\n                    </div>\n                </div>`,
        id: a.id,
        value: a.value
    ...
    return a.doNotRender
      ...
      : {
          html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${
            ...
            a.label
          )}</label>\n                        <select data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${
            a.readOnlyAttribute
          } id="${a.id}" name="${a.id}">\n                            ${(function () {
            for (var t = '', e = 0; e < a.options.length; e++) {
              var r = a.options[e]
              t += `<option ${r.value == a.value ? 'selected' : ''} value="${OrgChart._escapeDoubleQuotes(
                r.value
    ...
    return a.doNotRender
      ...
      : {
          html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${
            ...
            a.label
          )}</label>\n                        <input data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${
            a.readOnlyAttribute
          } maxlength="256" id="${a.id}" name="${a.id}" type="date" value="${OrgChart._escapeDoubleQuotes(
            a.value
          )}" autocomplete="off">\n                    </div>\n                </div>`,
          id: a.id,
          value: a.value
  ...
  (OrgChart.input.initWithTimeout = function () {
    OrgChart.input._timeout && (clearTimeout(OrgChart.input._timeout), (OrgChart.input._timeout = null)),
  ...
  (OrgChart.input.blurHandler = function (t) {
    ...
    e.classList.remove('focused'),
      t.value || 'date' == t.type ? e.classList.add('hasval') : e.classList.remove('hasval')
  }),
  (OrgChart.input.validate = function (t) {
    ...
    return a && '' == e.value
      ? ((r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + a + '</span>'),
        e.classList.add('boc-validation-error'),
        !1)
      : n && !OrgChart.input.validatePassword(e.value)
      ? ((r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + n + '</span>'),
        e.classList.add('boc-validation-error'),
        !1)
      : o && !OrgChart.input.isValidEmail(e.value)
      ? ((r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + o + '</span>'),
        e.classList.add('boc-validation-error'),
        !1)
      : !(l && !OrgChart.input.isValidEmails(e.value)) ||
        ((r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + l + '</span>'),
        e.classList.add('boc-validation-error'),
        !1)
  }),
  ...
  (OrgChart.filterUI.prototype.update = function () {
    if (this.instance.config.filterBy) {
      ...
      else if ('object' == typeof this.instance.config.filterBy) for (var i in this.instance.config.filterBy) t[i] = {}
      for (var a in t) {
        var n = t[a]
      ...
      if (null != this.filterBy)
        for (var l in t)
          if (this.filterBy[l]) for (var s in t[l]) this.filterBy[l][s] && (t[l][s] = this.filterBy[l][s])
      this.filterBy = t
      var h = this,
      ...
      c && c.parentNode.removeChild(c),
        ...
        c.setAttribute('class', 'boc-filter'),
                  ...
                  if (e) {
                    ...
                    if (t.target.hasAttribute('data-all')) {
                      for (var i = t.target.parentNode.parentNode.querySelectorAll('input'), a = 0; a < i.length; a++)
                        if (i[a] != t.target)
                          for (var n in ((i[a].checked = t.target.checked), h.filterBy[r]))
  ...
  (OrgChart.local._setPositions = function (t, e, r) {
    for (var i = {}, a = {}, n = {}, o = 0; o < t.length; o++) {
      if ((g = t[o]).stContainerNodes)
        for (var l = g.stContainerNodes.length - 1; l >= 0; l--) {
          var s = g.stContainerNodes[l],
            h = OrgChart.local._walk(s.stChildren, e)
          if (
            ((s.w = h.maxX - h.minX + s.padding[3] + s.padding[1]),
            (s.h = h.maxY - h.minY + s.padding[0] + s.padding[2]),
            s.stChildren.length && 0 == s.padding[0] && 0 == s.padding[1] && 0 == s.padding[2] && 0 == s.padding[3])
          ) {
            var c = e[s.stChildren[0].lcn ? s.stChildren[0].lcn : 'base'],
              d = e[s.lcn ? s.lcn : 'base']
            ;((c.orientation == OrgChart.orientation.bottom && d.orientation == OrgChart.orientation.top) ||
              (c.orientation == OrgChart.orientation.top && d.orientation == OrgChart.orientation.bottom)) &&
              OrgChart.local._centerGroupIfBidirectionalChart(g, s, a, h, 'x'),
              ((c.orientation == OrgChart.orientation.left && d.orientation == OrgChart.orientation.right) ||
                (c.orientation == OrgChart.orientation.right && d.orientation == OrgChart.orientation.left)) &&
                OrgChart.local._centerGroupIfBidirectionalChart(g, s, n, h, 'y')
          }
          s._m && ((s._m.w = s.w), (s._m.h = s.h)), (i[s.id] = h)
        }
    }
    ...
    for (o = 0; o < t.length; o++) {
      var g
      if ((g = t[o]).stContainerNodes)
        for (l = 0; l < g.stContainerNodes.length; l++) {
          var p = (s = g.stContainerNodes[l]).x,
            f = s.y
          void 0 !== a[g.id] && void 0 !== a[g.id][s.id] && (p += a[g.id][s.id]),
            void 0 !== n[g.id] && void 0 !== n[g.id][s.id] && (f += n[g.id][s.id])
          for (var u = 0; u < s.stChildren.length; u++) {
            var C = s.stChildren[u]
            OrgChart.local._lastWalk(C, p, f, i[s.id], s.padding)
          }
        }
    }
    r()
  ...
  (OrgChart.local._walk = function (t, e) {
    for (var r = { minX: null, minY: null, maxX: null, maxY: null }, i = [], a = [], n = [], o = 0; o < t.length; o++) {
      var l = e[t[o].lcn ? t[o].lcn : 'base']
      0 == o - (s = parseInt(o / l.columns)) * l.columns && (n = []), OrgChart.local._firstWalk(t[o], 0, i, n, l)
    }
    for (o = 0; o < t.length; o++) {
      ;(l = e[t[o].lcn ? t[o].lcn : 'base']), (s = parseInt(o / l.columns)), l.columns
      var s,
        h = 0
      switch (
        (s > 0 && (h = a[s - 1] + l.siblingSeparation),
  ...
  (OrgChart.local._firstWalk = function (t, e, r, i, a) {
    if (!t.isPartner) {
      ...
      if (
        ...
        for (var o = t.children.length, l = 0; l < o; l++) OrgChart.local._firstWalk(t.children[l], e + 1, r, i, a)
        ...
        if (
          (s.isAssistant &&
            h.isAssistant &&
            t.children.length > 1 &&
            t.children[1].isSplit &&
            (c = t.children[1]._prelim + OrgChart.local._mid(t.children[1], a)),
          s.layout &&
            h.layout &&
            'mirror' != s.templateName &&
            'mirror' != h.templateName &&
            t.children.length > 1 &&
            t.children[1].isSplit &&
            (c = t.children[1]._prelim + OrgChart.local._mid(t.children[1], a)),
          ...
          if (t.isAssistant) d = a.assistantSeparation
          else if (2 == n.layout) d = a.mixedHierarchyNodesSeparation
          else if (n.parent && 4 == n.parent.hasPartners && a.orientation <= 3) {
            ;(g = OrgChart.local._size(n.parent, a)), (p = OrgChart.local._rightMidPoint(n, a))
        ...
        } else a.orientation <= 3 ? (t._prelim = c) : (t._prelim = 0)
  ...
  (OrgChart.local._secondWalk = function (t, e, r, i, a, n, o) {
    if (e <= OrgChart.MAX_DEPTH && !t.isPartner) {
      var l,
        ...
        h = i,
        c = 0
      if (((c = a[e]), (l = OrgChart.local._getNodeHeight(t, o)), t.layout)) {
        var d = 0,
          g = 0,
          p = 0,
          f = 0
        t.leftNeighbor &&
          t.leftNeighbor.layout &&
          t.leftNeighbor.pid == t.pid &&
          ((d = OrgChart.local._getNodeHeight(t.leftNeighbor, o)),
          t.leftNeighbor.leftNeighbor &&
            t.leftNeighbor.leftNeighbor.layout &&
            t.leftNeighbor.leftNeighbor.pid == t.pid &&
            (p = OrgChart.local._getNodeHeight(t.leftNeighbor.leftNeighbor, o))),
          t.rightNeighbor &&
            t.rightNeighbor.layout &&
            t.rightNeighbor.pid == t.pid &&
            ((g = OrgChart.local._getNodeHeight(t.rightNeighbor, o)),
            t.rightNeighbor.rightNeighbor &&
              t.rightNeighbor.rightNeighbor.layout &&
              t.rightNeighbor.rightNeighbor.pid == t.pid &&
              (f = OrgChart.local._getNodeHeight(t.rightNeighbor.rightNeighbor, o))),
          (c = Math.max(l, d, g, p, f))
      }
      switch (
        ((t.x = s),
        (t.y = h),
      ...
      if ((OrgChart._setMinMaxXY(t, n), 0 != t.children)) {
        var C = o.levelSeparation
        t.layout && (C = o.mixedHierarchyNodesSeparation)
        var m = 0
        if (
          (OrgChart.local._secondWalk(t.children[m], e + 1, r + t._modifier, i + c + C, a, n, o),
          t.children[m].isPartner)
        ) {
          for (; t.children.length - 1 > m && t.children[m].isPartner; ) OrgChart._setMinMaxXY(t.children[m], n), m++
          OrgChart._setMinMaxXY(t.children[m], n),
            OrgChart.local._secondWalk(t.children[m], e + 1, r + t._modifier, i + c + C, a, n, o)
        }
      }
      var O = OrgChart.local._getRightSibling(t)
      null != O && OrgChart.local._secondWalk(O, e, r, i, a, n, o)
    } else OrgChart.local.nodeIsPartnerPosition(t, o, a, e)
  }),
  (OrgChart.local._lastWalk = function (t, e, r, i, a) {
    ;(t.x += e + a[3] - i.minX), (t.y += r + a[0] - i.minY)
  ...
  (OrgChart.local._apportion = function (t, e, r, i) {
    if (!t.isPartner)
      for (
        var a = OrgChart.local._fChild(t), n = a.leftNeighbor, o = 1, l = OrgChart.MAX_DEPTH - e;
        null != a && null != n && o <= l;

      ) {
        for (var s = 0, h = 0, c = a, d = n, g = 0; g < o; g++)
          (c = c.parent), (d = d.parent), (s += c._modifier), (h += d._modifier)
        var p = i.subtreeSeparation
        2 == t.layout && (p = i.mixedHierarchyNodesSeparation)
        var f = n._prelim + h + OrgChart.local._nodeWithPartnersSize(n, i) + p - (a._prelim + s)
        if (f > 0) {
          for (var u = t, C = 0; null != u && u != d; u = OrgChart.local._getLeftSibling(u)) C++
          if (null != u)
            for (var m = t, O = f / C; m != d; m = OrgChart.local._getLeftSibling(m)) {
              ;(m._prelim += f), (m._modifier += f), (f -= O)
            }
        }
        o++,
          null !=
            (a = OrgChart.local._hasChildren(a) ? OrgChart.local._fChild(a) : OrgChart.local._getLeftmost(t, 0, o)) &&
            (n = a.leftNeighbor)
      }
  }),
  (OrgChart.local._mixedTreeHeight = function (t) {
    ...
    for (var e = 0; e < t.node.children.length; e++) (t.node = t.node.children[e]), OrgChart.local._mixedTreeHeight(t)
  }),
  ...
  (OrgChart.local._setNeighbors = function (t, e, r) {
    ;(r[e] && r[e].id === t.id) ||
      ((t.leftNeighbor = r[e]), null != t.leftNeighbor && (t.leftNeighbor.rightNeighbor = t), t.isPartner || (r[e] = t))
  }),
  ...
  (OrgChart.local._getNodeHeight = function (t, e) {
    switch (e.orientation) {
      ...
      case OrgChart.orientation.bottom_left:
        return Math.max(
          OrgChart.local._getPartnerRightPanelHeight(t, e),
          t.h,
          OrgChart.local._getPartnerLeftPanelHeight(t, e)
        )
      case OrgChart.orientation.right:
      case OrgChart.orientation.right_top:
      case OrgChart.orientation.left:
      case OrgChart.orientation.left_top:
        return Math.max(
          OrgChart.local._getPartnerRightPanelWidth(t, e),
          t.w,
          OrgChart.local._getPartnerLeftPanelWidth(t, e)
        )
    }
    return 0
  }),
  ...
  (OrgChart.local._getLeftmost = function (t, e, r) {
    if (e >= r) return t
    if (!OrgChart.local._hasChildren(t)) return null
  ...
  (OrgChart.local.nodeHasPartnersPosition = function (t, e, r) {
    switch (e.orientation) {
      ...
      case OrgChart.orientation.bottom_left:
        ...
        ;(t.x += i),
          t.h < r &&
            (e.orientation == OrgChart.orientation.bottom || e.orientation == OrgChart.orientation.bottom_left
              ? (t.y -= (r - t.h) / 2)
              : (t.y += (r - t.h) / 2))
        break
      case OrgChart.orientation.right:
      ...
      case OrgChart.orientation.left_top:
        ...
        ;(t.x += a),
          t.w < r &&
            (e.orientation == OrgChart.orientation.right || e.orientation == OrgChart.orientation.right_top
              ? (t.y -= (r - t.w) / 2)
              : (t.y += (r - t.w) / 2))
    }
  }),
    ...
    switch (e.orientation) {
      ...
      case OrgChart.orientation.bottom_left:
        ...
        for (var f = 0; f < t.parent.children.length; f++) {
          1 == (u = t.parent.children[f]).isPartner
            ? ((o = t.parent.x + t.parent.w + t.parent.partnerSeparation),
              g
                ? ((l = t.parent.y - (r[i - 1] - t.parent.h) / 2 + (r[i - 1] - n) / 2), (d = u.h), (g = !1))
                : ((l += d + e.partnerNodeSeparation), (d = u.h)),
              (u.x = o),
              (u.y = l))
            : 2 == u.isPartner &&
              ((s = t.parent.x - u.w - t.parent.partnerSeparation),
              p
                ? ((h = t.parent.y - (r[i - 1] - t.parent.h) / 2 + (r[i - 1] - a) / 2), (c = u.h), (p = !1))
                : ((h += c + e.partnerNodeSeparation), (c = u.h)),
              (u.x = s),
              (u.y = h))
        }
        break
      ...
      case OrgChart.orientation.left_top:
        ...
        for (f = 0; f < t.parent.children.length; f++) {
          var u
          ;(u = t.parent.children[f]) &&
            (1 == u.isPartner
              ? ((l = t.parent.y + t.parent.h + t.parent.partnerSeparation),
                g
                  ? ((o = t.parent.x - (r[i - 1] - t.parent.w) / 2 + (r[i - 1] - n) / 2), (d = u.w), (g = !1))
                  : ((o += d + e.partnerNodeSeparation), (d = u.w)),
                (u.x = o),
                (u.y = l))
              : 2 == u.isPartner &&
                ((h = t.parent.y - u.h - t.parent.partnerSeparation),
                p
                  ? ((s = t.parent.x - (r[i - 1] - t.parent.w) / 2 + (r[i - 1] - a) / 2), (c = u.w), (p = !1))
                  : ((s += c + e.partnerNodeSeparation), (c = u.w)),
                (u.x = s),
                (u.y = h)))
        }
    }
  ...
  (OrgChart.local._getPartnerRightPanelWidth = function (t, e) {
    ...
    switch (e.orientation) {
      ...
      case OrgChart.orientation.bottom_left:
        ...
        return r && (r += t.partnerSeparation), r
      case OrgChart.orientation.right:
      case OrgChart.orientation.right_top:
      case OrgChart.orientation.left:
      case OrgChart.orientation.left_top:
        ...
        return r && (r -= e.partnerNodeSeparation), r
    }
  }),
  ...
  (OrgChart.local._fChild = function (t) {
    for (var e = 0; e < t.children.length && t.children[e].isPartner; ) e++
    return t.children[e]
  }),
  (OrgChart.local._hasChildren = function (t) {
    for (var e = 0; e < t.children.length; e++) if (!t.children[e].isPartner) return !0
    return !1
  }),
  (OrgChart.local._centerGroupIfBidirectionalChart = function (t, e, r, i, a) {
    for (
      var n = a.toUpperCase(), o = 'max' + n, l = 'x' == a ? 'w' : 'h', s = null, h = null, c = 0;
      c < e.stChildren.length;
      c++
    )
      (null === s || e.stChildren[c][a] > s + e.stChildren[c][l]) && (s = e.stChildren[c][a] + e.stChildren[c][l]),
        (null === h || h < e.stChildren[c][a]) && (h = e.stChildren[c][a])
    r[t.id] || (r[t.id] = {})
    var d = (s - h) / 2 + h,
      g = i[o] - s + (s - h) / 2
    g > d ? ((r[t.id][e.id] = g - d), (e[l] = 2 * g)) : ((r[t.id][e.id] = 0), (e[l] = 2 * d))
  })
